export default interface IDrawflow {
    /**
     * Active reroute
     * @default false
     */
     ...
     */
    addNode(name: string, inputs: number, outputs: number, posx: number, posy: number, className: string, data: any, html: string, typenode: DrawflowNode['typenode']): DrawflowNode['id'];
    /**
     *  Increment zoom +0.1
     */
    zoom_in(): void;
     ...
     * @param input_class
     */
    removeSingleConnection(id_output: string | number, id_input: string | number, output_class: string, input_class: string): void;
    /**
