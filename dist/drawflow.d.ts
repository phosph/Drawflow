...
export declare class Drawflow implements IDrawflow {
    ...
    private evCache;
    private prevDiff;
    constructor(container: HTMLElement, render?: object | undefined, parent?: object | undefined);
    start(): void;
    private pointerdown_handler;
    private pointermove_handler;
    private pointerup_handler;
    private remove_event;
    load(): void;
    ...
    private dblclick;
    private createReroutePoint;
    private removeReroutePoint;
    /**
     *
    ...
    registerNode(name: string, component: any, props: object, options: object): void;
    /**
     ...
     * @param input_class
     */
    removeSingleConnection(id_output: string | number, id_input: string | number, output_class: string, input_class: string): boolean;
    /**
     ...
     */
    import(data: DrawflowExport, notifi?: boolean): void;
    /**
     *
     * @param eventName
